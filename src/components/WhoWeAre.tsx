    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="w-full flex flex-col items-center gap-6">
        ...
        <div className="flex justify-center items-center">
          <div className="w-32 h-32 md:w-40 md:h-40 rounded-full border-4 border-[#003366] bg-white flex items-center justify-center overflow-hidden shadow-md">
        ...
        <div className="w-full max-w-3xl text-center">
          ...
          <p className="text-gray-600 mb-2 text-justify" style={{ fontFamily: 'Poppins, Arial, Helvetica, sans-serif', fontSize: '20px' }}>
            ...
            <span className="text-[#003366] font-bold"> DENSO</span>, 
            <span className="text-[#003366] font-bold"> COOL GEAR</span>, and 
            <span className="text-[#003366] font-bold"> SANDEN</span>.
          </p>
